  ...
  return (
    <section className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-bold text-slate-800">Auditoria de moderacion</h2>
          <p className="text-sm text-slate-500">Ultimas acciones administrativas y de moderacion persistidas.</p>
        </div>
        <button
          type="button"
          onClick={() => refetch()}
