...
**Primary Dependencies**: [e.g., FastAPI, Apollo, EF Core or NEEDS CLARIFICATION]
...
**Performance Goals**: [domain-specific, e.g., 1000 req/s, <1s page load or NEEDS CLARIFICATION]
